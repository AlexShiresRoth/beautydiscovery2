  ...
  <div class="header__inner">
    <div class="story-title">
      ...
      <div class="caption">
        ...
        <div class="icons">
          <Icon data={facebook} style="margin-right: .2rem; color:#932f6d" />
          <Icon data={instagram} style="margin:0 .2rem; color:#932f6d" />
          <Icon data={youtube} style="margin:0 .2rem; color:#932f6d" />
          <Icon data={pinterest} style="margin:0 .2rem; color:#932f6d" />
          <Icon data={envelope} style="margin:0 .2rem; color:#932f6d" />
        </div>
      </div>
    </div>
  </div>
